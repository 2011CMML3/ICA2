...
The generation pipeline is stored at **Resolution/Data_Generation/tutorial_resolution.ipynb** which uses the single cell RNA-seq data to simulate gene expression profiles. Random spatial patterns of the genes are also simulated.
